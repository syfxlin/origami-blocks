...
registerBlockType("origami/notebox", {
	...
	edit: function(props) {
		var content_ele = wp.element.createElement(wp.components.TextControl, {
		...
		var selected_ele = wp.element.createElement(wp.components.SelectControl, {
			label: "选择样式",
...
registerBlockType("origami/prism", {
	...
	edit: function(props) {
		var content_ele = wp.element.createElement(wp.components.TextareaControl, {
			label: "Origami 代码块",
			value: props.attributes.content,
			onChange: function(val) {
				props.setAttributes({ content: val });
		...
		var lang_ele = wp.element.createElement(wp.components.TextControl, {
			label: "代码语言",
